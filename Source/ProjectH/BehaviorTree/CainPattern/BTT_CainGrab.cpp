...
#include "BehaviorTree/CainPattern/BTT_CainGrab.h"
#include "AIController.h"
#include "Interface/CainPatternInterface.h"
#include "BehaviorTree/BlackboardComponent.h"
#include "Data/CainAIKey.h"

UBTT_CainGrab::UBTT_CainGrab()
{
}

EBTNodeResult::Type UBTT_CainGrab::ExecuteTask(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory)
{
	...
	// 공격
	AIPawn->PlayMontageByAI(EMontages::GRAB);
