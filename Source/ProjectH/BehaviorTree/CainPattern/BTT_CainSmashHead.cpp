...
#include "BehaviorTree/CainPattern/BTT_CainSmashHead.h"
#include "AIController.h"
#include "Interface/CainPatternInterface.h"
#include "BehaviorTree/BlackboardComponent.h"
#include "Data/CainAIKey.h"

UBTT_CainSmashHead::UBTT_CainSmashHead()
{
}

EBTNodeResult::Type UBTT_CainSmashHead::ExecuteTask(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory)
{
