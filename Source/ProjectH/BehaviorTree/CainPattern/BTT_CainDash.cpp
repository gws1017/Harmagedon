...
#include "BehaviorTree/CainPattern/BTT_CainDash.h"
#include "AIController.h"
#include "Interface/CainPatternInterface.h"
#include "BehaviorTree/BlackboardComponent.h"
#include "Data/CainAIKey.h"

UBTT_CainDash::UBTT_CainDash()
{
}

EBTNodeResult::Type UBTT_CainDash::ExecuteTask(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory)
{
