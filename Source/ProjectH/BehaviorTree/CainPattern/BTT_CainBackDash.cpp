...
#include "BehaviorTree/CainPattern/BTT_CainBackDash.h"
#include "AIController.h"
#include "Interface/CainPatternInterface.h"
#include "BehaviorTree/BlackboardComponent.h"
#include "Data/CainAIKey.h"

UBTT_CainBackDash::UBTT_CainBackDash()
{
}

EBTNodeResult::Type UBTT_CainBackDash::ExecuteTask(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory)
{
	...
	// 공격
	AIPawn->PlayMontageByAI(EPattern::DASH);
